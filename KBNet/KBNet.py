...
# LayerNorm2d and SimpleGate remain the same as in the provided reference code
...
# KBAFunction and KBBlock_s as provided
...
class KBNet(nn.Module):
    def __init__(self, img_channel=1, width=64, middle_blk_num=12, enc_blk_nums=[2, 2, 4, 8], dec_blk_nums=[2, 2, 2, 2], basicblock='KBBlock_s', lightweight=False, ffn_scale=2):
        super().__init__()
