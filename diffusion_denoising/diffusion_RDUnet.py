...
unet_checkpointed = RDUNet(base_filters=128).to(device)
...
if __name__ == "__main__":
    try:
        ...
        train_loader, val_loader = load_data(image_folder, batch_size=2, augment=False, dataset_percentage=0.1, validation_split=0.1, use_rgb=True, num_workers=8)
        
        # Load checkpoint if exists
        checkpoint_path = os.path.join("checkpoints", "diffusion_RDUnet_model_checkpointed_epoch_200.pth")
