...
def train_denoising_gan(train_loader, val_loader, num_epochs, lambda_pixel, lambda_perceptual, lambda_edge, lambda_gp,
                        lr, betas, device, log_dir, checkpoint_dir, checkpoint_prefix, trial=None):
    ...
    for epoch in range(num_epochs):
        ...
        if val_loss < best_val_loss:
            ...
            torch.save(generator.state_dict(), f"{checkpoint_dir}/{checkpoint_prefix}_generator_best.pth")
            torch.save(discriminator.state_dict(), f"{checkpoint_dir}/{checkpoint_prefix}_discriminator_best.pth")
